 ...
 */
public class UndirectedIntCsvEdgeInputFormat extends TextEdgeInputFormat<IntWritable,NullWritable>{
    ...
    public EdgeReader<IntWritable, NullWritable> createEdgeReader(InputSplit split, TaskAttemptContext context) throws IOException {
        EdgeReader<IntWritable, NullWritable> reader =  new ReverseEdgeDuplicator<IntWritable,NullWritable>(new  UndirectedIntCsvEdgeReader());
        return reader;
    }

    public class UndirectedIntCsvEdgeReader extends  TextEdgeReaderFromEachLineProcessed<IntPair> {
        @Override
